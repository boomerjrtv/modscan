...
- Use simple test URLs like `http://192.0.2.1/dvwa/vulnerabilities/sqli` NOT full parameter URLs

### ✅ Example Debug Approach

```python
# TEMPORARY debug script - DELETE after fixing core issue
# Test authentication on simple URL: http://192.0.2.1/dvwa/vulnerabilities/sqli
# NOT: http://192.0.2.1/dvwa/vulnerabilities/sqli/?id=1&Submit=Submit
