...
urls = [
  "http://192.0.2.1/dvwa/vulnerabilities/sqli/?id=1",
  "http://192.0.2.1/dvwa/vulnerabilities/xss_r/?name=test",
  "http://192.0.2.1/dvwa/vulnerabilities/fi/?page=include.php",
  "http://192.0.2.1/dvwa/vulnerabilities/redirect/?page=http://example.com"
]
cfg = json.load(open('config.json')); cfg['auth_cookie'] = os.environ.get('DVWA_COOKIE',''); cfg['auth_domain'] = '192.0.2.1'
